...
//         )
        ...
        console.log('%I know what you are doing here', 'color: #32ffce');
        console.log('%cCheckout my company Journey 👉 midnightdesigner.nl,', 'color: #32ffce');
        console.log('%c— hemetulha', 'color: #777777');
    }
